...
class Dataset_ETT_hour(Dataset):
    ...
    def __getitem__(self, index):
        s_begin = index * self.pred_len if self.set_type == 2 else index
    ...
    def __len__(self):
        return (len(self.data_x) - self.seq_len - self.pred_len) // self.pred_len + 1 if self.set_type == 2 else len(
            self.data_x) - self.seq_len - self.pred_len + 1
